 ...
 * The class always performs all the checks while iterating through the tiles in east direction.
 * 
 * @author Ayam Ajmera
 * @version 1.0
 * @since 2020-05-12
...
public class MoveEastStrategy implements Strategy 
{
	 ...
	 * @since 1.0
	 */
	public MoveEastStrategy(RowIterator iter)
	{
		this.iterator = iter;
	}
