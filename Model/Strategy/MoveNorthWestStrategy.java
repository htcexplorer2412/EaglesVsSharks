 ...
 * The class always performs all the checks while iterating through the tiles in north and west direction.
 * 
 * @author Ayam Ajmera
 * @version 1.0
 * @since 2020-05-12
...
public class MoveNorthWestStrategy implements Strategy 
{
	 ...
	 */
	private ReverseColumnIterator iterator;
	
	/**
	 * 
	 * @param iter - ReverseColumnIterator object for Tile collection
	 * @version 1.0
	 * @since 1.0
	 */
	public MoveNorthWestStrategy(ReverseColumnIterator iter)
	{
		this.iterator = iter;
	}
	 
	/**
	 * Check between source and destination for blocked pathways using the ReverseColumnIterator.
	 * 
	...
	/**
	 * Check between source and destination for a piece from any team using the ReverseColumnIterator.
	 * 
	 * @param prevPointX Source point on X-axis
	 * @param prevPointY Source point on Y-axis
	 * @param pointX 	 Destination point on X-axis
