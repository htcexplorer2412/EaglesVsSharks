 ...
 * The class always performs all the checks while iterating through the tiles in north and east direction.
 * 
 * @author Ayam Ajmera
 * @version 1.0
 * @since 2020-05-12
...
public class MoveNorthEastStrategy implements Strategy 
{
	 ...
	 * @since 1.0
	 */
	public MoveNorthEastStrategy(ColumnIterator iter)
	{
		this.iterator = iter;
	}
