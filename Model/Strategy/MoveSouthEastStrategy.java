 ...
 * The class always performs all the checks while iterating through the tiles in south and east direction.
 * 
 * @author Ayam Ajmera
 * @version 1.0
 * @since 2020-05-12
...
public class MoveSouthEastStrategy implements Strategy 
{
	 ...
	 * @since 1.0
	 */
	public MoveSouthEastStrategy(RowIterator iter)
	{
		this.iterator = iter;
	}
