 ...
 * The class always performs all the checks while iterating through the tiles in north direction.
 * 
 * @author Ayam Ajmera
 * @version 1.0
 * @since 2020-05-12
...
public class MoveNorthStrategy implements Strategy 
{
	 ...
	 * @since 1.0
	 */
	public MoveNorthStrategy(ReverseColumnIterator iter)
	{
		this.iterator = iter;
	}
